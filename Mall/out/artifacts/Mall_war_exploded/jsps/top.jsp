...
<div style="font-size: 10pt;">
		...
		您好：${username}&nbsp;&nbsp;|&nbsp;&nbsp;
		<a href="<c:url value='http://localhost:8080/cart?method=show'/>" target="body">我的购物车</a>&nbsp;&nbsp;|&nbsp;&nbsp;
		<a href="<c:url value='/jsps/order/list.jsp'/>" target="body">我的订单</a>&nbsp;&nbsp;|&nbsp;&nbsp;
		<a href="<c:url value="http://localhost:8080/book?method=removeUser"/> "target="_parent" > 退出</a>
		</c:if>
		<br/>
